...
import com.Runner.MiauDx.UserSettingsActivity;
...
public class CQModeActivity extends AppCompatActivity {
     ...
     */
    public void addNewDX(String callSign, String comment, String location) {
        runOnUiThread(() -> {
            Dx newDx = new Dx(callSign, comment, location);
            dxList.add(newDx);
